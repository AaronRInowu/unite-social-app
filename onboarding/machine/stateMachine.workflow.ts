...
import InsertStory from "@/components/Screens/OnboardingSteps/OnStory";
...
export const stateMachine: StateMachineDefinition = {
  states: {
    ...
    yourTypeEvents: {
      ...
      PROPS: {
        wrapper: {
          ...
          subtitle: "Your scene. Your people. Find where the sparks happen.",
        },
        component: {
          options: vibes,
          headers: {
    ...
    createFirstStory: {
      ...
      NUMBER: 11,
      PREV: "yourTypeEvents",
      COMPONENT: InsertStory,
      PROPS: {
        wrapper: {
          title: "Let’s start your first story!",
          subtitle:
            "We built your story based on what you shared, but you can change it to make it fit you better.",
